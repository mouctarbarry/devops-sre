...
| **CD** — Continuous Delivery | Chaque commit est *pret* à être déployé | + staging, approval gates |
...
v2 v2 v2 v2    (déploiement termine)
```
...
**Avantages** : risque minimal, validation en productionréelle
...
- Kill switch instantané en cas de probleme
- A/B testing natif
