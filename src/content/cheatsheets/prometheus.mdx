...
tags: [prometheus, monitoring, promql, alerting, metriques]
---
...
## RED Method — metriques pour les services
...
## USE Method — metriques pour les ressources
    ...
    rules:
      - alert: HighErrorRate
        ...
        annotations:
          ...
          description: "{{ $value | humanizePercentage }} des requetes echouent"
